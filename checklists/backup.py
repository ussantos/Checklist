...
ENV_BACKUP_KEYS = [
    ...
    'SPONTE_API_WAIT_ON_RATE_LIMIT',
    'SPONTE_API_RATE_LIMIT_WAIT_PADDING_SECONDS',
    'SPONTE_REST_API_ENABLED',
    'SPONTE_REST_API_BASE_URL',
    'SPONTE_REST_API_CLIENT_CODE',
    'SPONTE_REST_API_LOGIN',
    'SPONTE_REST_API_PASSWORD',
    'SPONTE_REST_API_TIMEOUT_SECONDS',
    'SPONTE_REST_API_TOKEN_TTL_MINUTES',
