...
MAX_EVIDENCE_FILE_SIZE_MB = min(int(os.environ.get('MAX_EVIDENCE_FILE_SIZE_MB', '5')), 5)
...
_SPONTE_CLIENT_CODE = os.environ.get('SPONTE_API_CLIENT_CODE', os.environ.get('SPONTE_CODIGO_CLIENTE', ''))
_SPONTE_TOKEN = os.environ.get('SPONTE_API_TOKEN', os.environ.get('SPONTE_TOKEN', ''))

SPONTE_API_ENABLED = _env_bool('SPONTE_API_ENABLED', bool(_SPONTE_CLIENT_CODE and _SPONTE_TOKEN))
SPONTE_API_BASE_URL = os.environ.get(
    'SPONTE_API_BASE_URL',
    os.environ.get('SPONTE_API_URL', 'https://api.sponteeducacional.net.br/WSAPIEdu.asmx'),
)
SPONTE_API_CLIENT_CODE = _SPONTE_CLIENT_CODE
SPONTE_API_TOKEN = _SPONTE_TOKEN
...
SPONTE_CODIGO_CLIENTE = SPONTE_API_CLIENT_CODE
SPONTE_TOKEN = SPONTE_API_TOKEN
SPONTE_STUDENT_SEARCH_PARAMS = os.environ.get('SPONTE_STUDENT_SEARCH_PARAMS', 'Situacao=1')
SPONTE_COURSE_SEARCH_PARAMS = os.environ.get('SPONTE_COURSE_SEARCH_PARAMS', 'Situacao=1')
SPONTE_TIMEOUT_SECONDS = SPONTE_API_TIMEOUT_SECONDS
SPONTE_SCHEDULE_SYNC_DAYS_BACK = int(os.environ.get('SPONTE_SCHEDULE_SYNC_DAYS_BACK', '0'))
SPONTE_SCHEDULE_SYNC_DAYS_AHEAD = int(os.environ.get('SPONTE_SCHEDULE_SYNC_DAYS_AHEAD', '90'))

GRAFANA_SYNC_ENABLED = _env_bool('GRAFANA_SYNC_ENABLED', True)
GRAFANA_API_URL = os.environ.get('GRAFANA_API_URL', 'http://grafana:3000').rstrip('/')
GRAFANA_ADMIN_USER = os.environ.get('GRAFANA_ADMIN_USER', 'admin')
GRAFANA_ADMIN_PASSWORD = os.environ.get('GRAFANA_ADMIN_PASSWORD', 'troque-esta-senha-grafana')
GRAFANA_DATASOURCE_UID = os.environ.get('GRAFANA_DATASOURCE_UID', 'checklist_postgres')
GRAFANA_SYNC_TIMEOUT_SECONDS = int(os.environ.get('GRAFANA_SYNC_TIMEOUT_SECONDS', '5'))
GRAFANA_SYNC_RETRIES = int(os.environ.get('GRAFANA_SYNC_RETRIES', '3'))
